...
import com.github.wxpay.sdk.demo.WXPay1;
...
//        reqData.put("nonce_str", WXPayUtil.generateNonceStr());
        reqData.put("nonce_str", "LBwfMUeqMB4TO2FaqQozFILbngJsV7J0");
...
//        reqData.put("sign", WXPay1.createSign(reqData, config.getKey()));
        return reqData;
    }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        System.out.println(JSON.toJSONString("map信息："+reqData));
        System.out.println(JSON.toJSONString("xml信息："+reqBody));
