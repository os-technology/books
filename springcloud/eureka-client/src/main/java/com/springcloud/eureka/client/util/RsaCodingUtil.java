...
public final class RsaCodingUtil {
	 ...
	 * @return
	 */
	public static String decryptByPubCerFile(String content, InputStream pubCerPath) {
		PublicKey publicKey = RsaReadUtil.getPublicKeyFromFile(pubCerPath);
		if (publicKey == null) {
			return null;
		}
	 ...
	 * @return
	 */
	public static String encryptByPriPfxFile(String src, InputStream inputStream, String priKeyPass) {

		PrivateKey privateKey = RsaReadUtil.getPrivateKeyFromFile(inputStream, priKeyPass);
		if (privateKey == null) {
			return null;
		}
		return encryptByPrivateKey(src, privateKey);
